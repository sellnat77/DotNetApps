    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            select new
            {
                ...
                Address = person.Element("Address") != null ? person.Element("Address").Value : string.Empty,
            ...
            foreach (var person in persons)
            {
                ...
                txtResults.Text = txtResults.Text + "Address: " + person.Address + "\n";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            xmlDoc.Element("Persons").Add(new XElement("Person", new XElement("Name", txtName.Text), 
                new XElement("Address", txtAddress.Text), new XElement("City", txtCity.Text), new XElement("Age", txtAge.Text)));
